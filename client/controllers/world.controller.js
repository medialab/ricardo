...
angular
  .module("ricardo.controllers.world", [])
  ...
  .controller("world", [
    ...
    function (
      ...
      $scope.RICentities = {};
      $scope.RICentitiesDD = d3
        .values($scope.RICentities)
        .sort(function (a, b) {
        ...
        worldFlowsYears.forEach(function (d) {
          if (d.key) {
            ...
            var sources = [
              ...
              imp
                ? imp.sources != (exp ? exp.sources : null)
                  ? imp.sources
                  : null
                : null,
            ].filter(function (e) {
      ...
      function updateTableData() {
        ...
        if ($scope.linechartData) {
          ...
          for (var i = 0; i < len; i++) {
            $scope.tableData = $scope.tableData.concat(
              $scope.linechartData[i].values
            );
          }
        }
      }
