    ...
    function init(year) {
      apiService
        ...
        .then(function (trades) {
            ...
            //$scope.sigma.addCamera('main');

            // var db = new sigma.plugins.neighborhoods();
            //     db.load(data, function() {
            //       var nodeId = 'anyNodeID';
            //        s.read(db.neighborhood(nodeId))
            //         .refresh();
            //     });
            ...
            $scope.sigma.startForceAtlas2({worker: true, barnesHutOptimize: true});
            ...
            // $scope.zoom = function () {
            //     $scope.sigma.misc.animation.camera(
            //       camera,
