...
angular
  .module("ricardo.controllers.network", [])
    ...
    function ($scope, $location, apiService, utils, reportingYears) {
      ...
      function communityDetection(
        ...
        node_data.forEach(function (n) {
          listNationsByKey[n].attributes["community"] =
            community_assignment_result[n];
        });
      ...
      var filename =
        "RICardo - Networt Trade Nations in " + $scope.selectedDate;
