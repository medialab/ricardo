...
angular
  .module("ricardo.directives.partnersHistogram", [])
  .directive("partnersHistogram", [
    "$timeout",
    function ($timeout) {
      return {
        restrict: "E",
        ...
        link: function (scope, element, attrs) {
          ...
          var height = 600,
            width = document.querySelector("#partners-histogram-container")
              .offsetWidth,
            marginTop = 15,
            marginLeft = 0,
            marginRight = 0,
          ...
          function partnersHistogram(
            ...
            var x = d3.scale
                ...
                .range([0, width]),
              y = d3.scale.linear().range([0, barMaxHeigth / 2]);
            ...
            data.forEach(function (p, i) {
              ...
              histo
                ...
                .attr("height", function (d) {
                  return d.balance
                    ? Math.max(barMinHeigth, y(Math.abs(d.balance)))
                    : 0;
                })
                .attr("fill", function (d) {
                  return barColors[+(d.balance >= 0)];
                })
                .attr("opacity", function (d) {
                  return d.imp !== null && d.exp !== null ? 1 : 0.3;
                })
                ...
                .on("mousemove", function (d) {
                  ...
                  return tooltip
                    .style(
                      "left",
                      Math.min(
                        window.innerWidth - wid - 20,
                        Math.max(0, d3.event.pageX - wid / 2)
                      ) + "px"
                    )
              ...
              if (order !== "name") {
                ...
                var rLittleCircle =
                  (formatPercent2(p["avg_" + order]) / 100) * rBigCircle;
                histo
                  .append("circle")
                  .attr("cx", 25)
                  .attr("cy", -40)
                ...
                histo
                  ...
                  .attr("font-size", "0.8em")
                  .text(function (d) {
                    return formatPercent(p["avg_" + order]);
                  }); // display number under circles
              }
            });
          }
        }, //end of link
