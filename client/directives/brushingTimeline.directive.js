      ...
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          var margin = { top: 6, right: 0, bottom: 6, left: 0 },
            width =
              document.querySelector("#brushing-timeline-container")
                .offsetWidth -
              margin.left -
              margin.right,
            ...
            baselineHeight_1on2 = scope.mirrorLines
              ? hOffset / 4
              : baselineHeight_1on1,
          ...
          function draw(data) {
            ...
            var entityDataAvaible = scope.sourceCountry
              ? scope.sourceCountry
              : "World";
          ...
          function updateBrush() {
            ...
            d3.select("#brushing-timeline-container svg")
              .select(".brush")
              .call(brush);
          }
        },
