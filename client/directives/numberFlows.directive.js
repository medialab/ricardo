...
/* Directives */
angular
  .module("ricardo.directives.numberFlows", [])
  /* directive with watch, update and draw functions */
  .directive("numberFlows", [
    function () {
      return {
        restrict: "E",
        ...
        link: function (scope, element, attrs) {
          ...
          function group_flows(data) {
            ...
            nbFlows.forEach(function (d) {
              for (var i = minDate; i <= maxDate; i++) {
                var years = d.values.map(function (v) {
                  return v.year;
                });
          ...
          var margin = { top: 20, right: 20, bottom: 20, left: 20 },
            width =
              document.querySelector("#number-flows-container").offsetWidth -
              margin.left -
              margin.right,
            height = 100,
            offsetHeight = 10;
          ...
          function draw(data) {
            ...
            var backbar = svg
              ...
              .on("mouseover", function (d) {
                ...
                // })
                tooltip_title.html(
                  "<h5>Number of " + yName + " Flows in " + d + "</h5"
                );
                // create table
