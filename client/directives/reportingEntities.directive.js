        ...
        link: function (scope, element, attrs) {
          ...
          scope.$watch("search", function (newValue, oldValue) {
            if (newValue) {
              ...
              d3.select("#r_" + scope.reporting)
                ...
                .selectAll("rect")
                .attr("height", gridHeight - gridGap + 15);
              $("#reporting-entities-container").animate(
              ...
              indexSelected = y
                .domain()
                .indexOf(d3.select("#r_" + scope.reporting).datum().key);
            }
          });
          ...
          function regroup(colorBy) {
            var yearData = scope.flatData.sort(function (a, b) {
              if (colorBy === "partner")
                return d3.descending(a[colorBy].length, b[colorBy].length);
          ...
          var margin = { top: 0, right: 13, bottom: 40, left: 180 },
            width =
              document.querySelector("#reporting-entities-container")
                .offsetWidth -
              margin.left -
              margin.right,
            height,
          ...
          var tip_margin = { top: 10, right: 0, bottom: 10, left: 0 },
            tip_width =
              document.querySelector(".matrix-tooltip").offsetWidth -
              tip_margin.left -
              tip_margin.right;
          ...
          function updateColor(colorBy, data) {
            if (colorBy === "partner" || colorBy === "partner_intersect") {
              ...
              if (colorBy === "reference") {
                ...
                color_domain = sort_color(
                  colorBy,
                  d3.set(color_domain).values()
                );
                categoryColor
                  .domain(color_domain)
                  .range([
          ...
          function recolor(colorBy, data) {
            ...
            d3.selectAll(".available")
              ...
              .style("fill", function (v) {
                ...
                else if (colorBy === "reference")
                  return categoryColor(world_partner_map[v[colorBy]]);
                else if (colorBy === "mirror_rate")
                  return v.mirror_rate !== undefined
                    ? scaleColor(v[colorBy])
                    : "none";
          ...
          function reorder(data) {
            ...
            if (layout === "alphabet") {
              ...
              d3.select("#reporting-entities-container")
                ...
                .attr("x", function (d) {
                  return d3.min([
                    marginScale(d[layout]),
                    margin.left - offset - 10,
                  ]);
                })
                .attr("width", function (d) {
                  return d3.max([
                    margin.left - offset - marginScale(d[layout]),
                    10,
                  ]);
                });
              d3.select("#reporting-entities-container")
          ...
          function draw(data) {
                  ...
                  d3.selectAll(".entities")
                    ...
                    .attr("transform", function (e) {
                      ...
                      var curXPos = +curTransform
                        .split(",")[0]
                        .replace("translate(", "");
                      var curYPos = +curTransform
                        .split(",")[1]
                        .replace(")", "");
                      return (
                        "translate(" + curXPos + "," + (curYPos + 15) + ")"
                      );
                    });
                }
              })
            ...
            entity.each(function (d) {
              ...
              available
                ...
                .on("mousemove", function (v) {
                  ...
                  tooltip
                    ...
                    .style(
                      "left",
                      Math.min(window.innerWidth, Math.max(0, d3.event.pageX)) -
                        wid / 2 +
                        "px"
                    )
              ...
              var sideChart = e
                ...
                .attr(
                  "transform",
                  "translate(-" + (5 + margin.left - offset) + ",0)"
                );
              ...
              sideChart
                ...
                .on("mouseover", function (d) {
                  ...
                  d3.select(this.parentNode)
                    .selectAll(".coverage_rect,.barLabel")
                    .style("opacity", 1);
              ...
              e.append("text")
                .text(function (d) {
                  if (d.key.split("(")[0].length > 23)
                    return d.key.split("(")[0].substring(0, 20) + "...";
                ...
                if ([37, 38, 39, 40].indexOf(d3.event.keyCode) > -1) {
                  ...
                  if (yearSelected !== null) {
                    if (d3.event.keyCode === 39) {
                      ...
                      var dotSelected = entitySelected
                        .selectAll(".available")
                        .filter(function (d) {
                    ...
                    if (d3.event.keyCode === 37) {
                      ...
                      yearSelected = +dotSelected[0][dotSelected[0].length - 1]
                        .__data__.year;
                    }
                  }
                  d3.selectAll(".available")
            ...
            function tooltipContext(tooltip, v) {
              ...
              if (colorBy === "reference")
                tooltip
                  .select(".reference")
                  .html(
                    "<hr><p style='font-weight:bold'>World Partner: <br>" +
                      v.reference +
                      "</p>"
                  );
              ...
              if (colorBy === "partner_intersect")
                tooltip
                  .select(".reference")
                  .html(
                    "<hr><p style='font-weight:bold'>Number of Mirror Partners: " +
