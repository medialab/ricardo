    ...
    function () {
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          var tooltip = d3.select("body").append("div").attr("class", "synth-tooltip").style("width", "160px");
          ...
          function group_reporting(_data, curveBy) {
            ...
            var thresScale = d3.scale.threshold().domain(threshold_in).range(threshold_out);
          ...
          function draw_legend(color_domain) {
            ...
            legend
              ...
              .style("fill", function (d) {
                return category === "partner" || category === "partner_intersect" ? scaleColor(d) : categoryColor(d);
              });
            legend
              .append("text")
              .attr("x", 15)
              ...
              .on("mouseover", function (d) {
                ...
                tr.append("td")
                  ...
                  .attr("fill", function (d) {
                    if (d.key !== "Total")
                      return category === "partner" || category === "partner_intersect"
                        ? scaleColor(d.key)
                        : categoryColor(d.key);
                    else return "none";
                  });
            ...
            layer.each(function (data, index) {
              ...
              e.selectAll("rect")
                ...
                .style("opacity", function (d) {
                  return category === "partner" || category === "partner_intersect" ? 0.8 : 0.7;
                })
