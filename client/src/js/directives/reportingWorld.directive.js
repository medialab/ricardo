    ...
    function () {
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          var tooltip = d3.select("body").append("div").attr("class", "continent-tooltip").style("width", "200px");
              ...
              if (svg.select("g").empty()) {
                var multi_g = svg
                  ...
                  .attr("transform", function (d, i) {
                    return "translate(0," + ((partners - 1 - i) * height) / partners + ")";
                  })
                  .attr("class", "multiple");
                ...
                multi_g.each(function (d, i) {
                  ...
                  var baseline = e.append("g").attr("class", "baselines").selectAll("g").data(d.values);

                  var baselineEnter = baseline.enter().append("g").attr("class", "baseline");
              ...
              svg
                ...
                .on("mousemove", function () {
                  ...
                  if (selectData.length > 0) {
                    ...
                    tooltip.select(".title").html("<h5>" + yName + " in " + d.getFullYear() + "</h5><hr>");
                    ...
                    tip_partner
                      ...
                      .attr("width", function (d) {
                        return d.values[yValue] !== null ? x_tip(d.values[yValue]) : 0;
                      })
                      .attr("height", 10)
                    ...
                    tip_partner
                      ...
                      .attr("x", function (d) {
                        return d.values[yValue] !== null ? x_tip(d.values[yValue]) + 2 : 2;
                      })
                      .attr("y", 9)
                ...
                .on("mouseout", function (d) {
                  ...
                  svg.selectAll(".baseline").selectAll("circle,line").style("opacity", 0);
                  svg.selectAll(".highlight").remove();
                });
            }
          } //end draw function
