      ...
      link: function (scope, element, attrs) {
        ...
        function partnersHistogram(data, order, indexYears, minDate, maxDate) {
          ...
          if (selection.select("svg").empty()) {
            chart = selection.append("svg").attr("width", width).attr("height", height);
          } else {
            chart = selection.select("svg").attr("width", width).attr("height", height);
          }
          ...
          var tooltip = d3.select("body").append("div").attr("class", "partners-tooltip");
          ...
          data.forEach(function (p, i) {
            ...
            histo
              ...
              .attr("height", function (d) {
                return d.balance ? Math.max(barMinHeigth, y(Math.abs(d.balance))) : 0;
              })
              ...
              .on("mousemove", function (d) {
                ...
                return tooltip
                  .style("left", Math.min(window.innerWidth - wid - 20, Math.max(0, d3.event.pageX - wid / 2)) + "px")
