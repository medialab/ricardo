/* Directives */
angular
  .module("ricardo.directives.dualTimeline", [])
      ...
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          function draw(data) {
            ...
            svg.append("path").datum(data).attr("class", "area-imp").attr("d", areaImp).attr("pointer-events", "none");

            svg.append("path").datum(data).attr("class", "line-imp").attr("d", lineImp).attr("pointer-events", "none");

            svg.append("path").datum(data).attr("class", "area-exp").attr("d", areaExp).attr("pointer-events", "none");

            svg.append("path").datum(data).attr("class", "line-exp").attr("d", lineExp).attr("pointer-events", "none");
