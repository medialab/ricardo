...
gulp.task("svg", function () {
  return gulp.src("svg/*").pipe(gulp.dest("build/svg"));
});
gulp.task("data", function () {
  return gulp.src("data/*.csv").pipe(gulp.dest("build/data"));
});

gulp.task("locales", function () {
  return gulp.src("js/locale*.json").pipe(gulp.dest("build/js/"));
});

gulp.task("templates", function () {
  return gulp.src("partials/**/*.html").pipe(gulp.dest("build/partials/"));
});

gulp.task("papers", function () {
  return gulp.src("papers/*.pdf").pipe(gulp.dest("build/"));
});
