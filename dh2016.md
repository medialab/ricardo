...
~~MS Access~~  
git(CSVs) + python scripts => sqlite  
  
Complete database to be released on github in 2017
...
- How to aggregate *partial datasets* ?
...
![bilateral trade data model](img/bilateraltrade.svg)
...
- complete dataset to be released in 2007
